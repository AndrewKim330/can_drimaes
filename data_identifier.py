...
def message_info_by_can_id(can_id, bus):
    ...
    if can_id == 0x0CFE6C17:
        ...
        info_set.append({"name": "IC_TotalVehicleDistance", "bit_st_pos": 0, "bit_len": 32})
        return info_set
    elif can_id == 0x18F0120B:
        info_set.append("ESC_ABS_BrakeSysSts")
        info_set.append({"name": "ECS_Reset_Progress", 0x0: "Reset Ongoing", 0x1: "Reset Ended Successfully",
                         0x2: "Reset Ended Failed", 0x3: "Reserved", "bit_st_pos": 60, "bit_len": 2})
        return info_set
    elif can_id == 0x0CFFB291:
        info_set.append("SasChas1Fr01")
        info_set.append({"name": "SteerWhlSnsrAg", "bit_st_pos": 0, "bit_len": 15})
        return info_set
    elif can_id == 0x18FFA57F:
        info_set.append("HVSM_MMIFBSts")
        info_set.append({"name": "HVSM_DrvSeatHeatSts", 0x0: "OFF", 0x1: "Level 1_Low", 0x2: "Level 2_Middle",
                         0x3: "Level 3_High", "bit_st_pos": 0, "bit_len": 2})
        info_set.append({"name": "HVSM_PassSeatHeatSts", 0x0: "OFF", 0x1: "Level 1_Low", 0x2: "Level 2_Middle",
                         0x3: "Level 3_High", "bit_st_pos": 2, "bit_len": 2})
        info_set.append({"name": "HVSM_DrvSeatVentnSts", 0x0: "OFF", 0x1: "Level 1_Low", 0x2: "Level 2_Middle",
                         0x3: "Level 3_High", "bit_st_pos": 4, "bit_len": 2})
        info_set.append({"name": "HVSM_PassSeatVentnSts", 0x0: "OFF", 0x1: "Level 1_Low", 0x2: "Level 2_Middle",
        ...
        info_set.append(
            {"name": "MMI_SteerWhlHeatgOnCmd", 0x0: "Off", 0x1: "Lo", 0x2: "Med", 0x3: "Hi", "bit_st_pos": 0,
             "bit_len": 2})
        info_set.append({"name": "MMI_SteerWhlTTun", "bit_st_pos": 2, "bit_len": 4})
        info_set.append({"name": "MMI_DrvSeatHeatgLvlSet", 0x0: "OFF", 0x1: "Level 1_Low", 0x2: "Level 2_Middle",
                         0x3: "Level 3_High", "bit_st_pos": 8, "bit_len": 2})
        info_set.append({"name": "MMI_PassSeatHeatgLvlSet", 0x0: "OFF", 0x1: "Level 1_Low", 0x2: "Level 2_Middle",
                         0x3: "Level 3_High", "bit_st_pos": 10, "bit_len": 2})
        info_set.append({"name": "MMI_DrvSeatVentnLvlSet", 0x0: "OFF", 0x1: "Level 1_Low", 0x2: "Level 2_Middle",
                         0x3: "Level 3_High", "bit_st_pos": 12, "bit_len": 2})
        info_set.append({"name": "MMI_PassSeatVentnLvlSet", 0x0: "OFF", 0x1: "Level 1_Low", 0x2: "Level 2_Middle",
                         0x3: "Level 3_High", "bit_st_pos": 14, "bit_len": 2})
        info_set.append(
            {"name": "MMI_TPMS_Reset_Set", 0x0: "No request", 0x1: "Request reset", 0x2: "Reserved", 0x3: "Invalid",
             "bit_st_pos": 16, "bit_len": 2})
        info_set.append(
            {"name": "MMI_RearJustRequest", 0x0: "No request", 0x1: "Off", 0x2: "On", 0x3: "Reserved", "bit_st_pos": 18,
             "bit_len": 2})
        return info_set
    elif can_id == 0x18FFD841:
        info_set.append("MMI_SoftSwSet")
        info_set.append(
            {"name": "MMI_HomeSafetyLightsTimeSet", 0x0: "No request", 0x1: "Request reset", 0x2: "Reserved",
             0x3: "Invalid", "bit_st_pos": 27, "bit_len": 3})
        info_set.append({"name": "MMI_RearDefrostKeyRequest", 0x0: "No request", 0x1: "Off", 0x2: "On", 0x3: "Reserved",
        ...
        info_set.append(
            {"name": "MMI_LDWEnableCommand", 0x0: "Disable Lane Departure Warning",
             0x1: "Enable Lane Departure Warning",
             0x2: "Reserved", 0x3: "Don´t care", "bit_st_pos": 0, "bit_len": 2})
        return info_set
        ...
        info_set.append(
            {"name": "MMI_OTA_UpdateState", 0x0: "Default", 0x1: "OTA Update in progress", 0x2: "OTA Update success",
             ...
             0x5: "OTA Update roll back failure", 0x6: "OTA Update roll back success", 0x7: "Reserved",
        ...
        info_set.append(
            {"name": "MMI_OTA_InfoShowStatus", 0x0: "Default", 0x1: "OTA information show successful",
        ...
        info_set.append(
            {"name": "MMI_OTA_UpdateSelected", 0x0: "Default", 0x1: "OTA Update Cancelled", 0x2: "OTA Update Confirmed",
             0x3: "Reserved", "bit_st_pos": 24, "bit_len": 2})
        info_set.append(
            {"name": "MMI_OTA_UpdateResultConfirm", 0x1: "No Confirm", 0x2: "Confirm", "bit_st_pos": 26, "bit_len": 1})
        info_set.append(
        ...
        info_set.append(
            {"name": "ACU_PassSeatbeltBucklestatus", 0x0: "Switch Off", 0x1: "Switch On", "bit_st_pos": 1, "bit_len": 1})
        info_set.append(
        ...
        if bus == "C-CAN":
            ...
            info_set.append({"name": "PMS_AcceleratorPedalPosition", "bit_st_pos": 32, "bit_len": 8})
        return info_set
        ...
        info_set.append({"name": "BCM_LowBeamSts", 0x0: "OFF", 0x1: "ON", "bit_st_pos": 3, "bit_len": 1})
        info_set.append({"name": "BCM_AutoLightSts", 0x0: "OFF", 0x1: "ON", "bit_st_pos": 5, "bit_len": 1})
        info_set.append({"name": "BCM_HighBeamSts", 0x0: "OFF", 0x1: "ON", "bit_st_pos": 6, "bit_len": 1})
        info_set.append({"name": "BCM_RearFogLightSts", 0x0: "OFF", 0x1: "ON", "bit_st_pos": 8, "bit_len": 1})
        info_set.append(
            {"name": "BCM_Central_unLock_CMD", 0x0: "Inactive", 0x1: "Active", "bit_st_pos": 10, "bit_len": 1})
        info_set.append({"name": "BCM_HazardSts", 0x0: "Inactive", 0x1: "Active", "bit_st_pos": 15, "bit_len": 1})
        info_set.append({"name": "BCM_PositionLight", 0x0: "OFF", 0x1: "ON", "bit_st_pos": 21, "bit_len": 1})
        info_set.append(
            {"name": "BCM_PowerMode", 0x0: "OFF", 0x1: "ACC", 0x2: "ON", 0x3: "Reserved", 0x4: "START", 0x5: "Reserved",
             0x6: "Reserved", 0x7: "Reserved", "bit_st_pos": 32, "bit_len": 3})
        return info_set
        ...
        info_set.append({"name": "BCM_AnyDoorAjar", 0x0: "Inactive", 0x1: "Active", "bit_st_pos": 11, "bit_len": 1})
        return info_set
    elif can_id == 0x18FFD521:
        info_set.append("BCM_MMIFBSts")
        info_set.append({"name": "BCM_HomeSafetyLightsTimeResp", 0X0: "No Delay", 0x1: "30s", 0x2: "60s", 0x3: "90s",
                         0x4: "Set Resp Fail", "bit_st_pos": 10, "bit_len": 3})
        info_set.append(
            {"name": "BCM_SWM_HeatdSteerWhlDiagc", 0x0: "OK", 0x1: "CmnFailr", 0x2: "NotEdgePres", 0x3: "EdgeSho",
             0x4: "SnsrFltT", 0x5: "FltPwrSplyErr", 0x6: "FltSwtHiSide", 0x7: "SigFailr", "bit_st_pos": 25,
             "bit_len": 3})
        info_set.append({"name": "BCM_RearDefrostKeyRequest", 0x0: "No Request", 0x1: "Off", 0x2: "On", 0x3: "Reserved",
                         "bit_st_pos": 28, "bit_len": 2})
        info_set.append(
            {"name": "BCM_RearfoldRequest", 0x0: "No Request", 0x1: "Off", 0x2: "On", 0x3: "Reserved", "bit_st_pos": 30,
             "bit_len": 2})
        return info_set
    elif can_id == 0x18FA7F21:
        info_set.append("SWS-LIN")
        info_set.append(
            {"name": "BtnR1Req", 0x0: "PsdNotPsd_NotPsd", 0x1: "PsdNotPsd_Psd", "bit_st_pos": 0, "bit_len": 1})
        info_set.append(
            {"name": "BtnR2Req", 0x0: "PsdNotPsd_NotPsd", 0x1: "PsdNotPsd_SPsd", 0x2: "PsdNotPsd_LPsd", 0x3: "Reserved",
             "bit_st_pos": 1, "bit_len": 2})
        info_set.append(
            {"name": "BtnR3Req", 0x0: "PsdNotPsd_NotPsd", 0x1: "PsdNotPsd_SPsd", 0x2: "PsdNotPsd_LPsd", 0x3: "Reserved",
             "bit_st_pos": 3, "bit_len": 2})
        info_set.append(
        ...
        info_set.append(
            {"name": "BtnR6Req", 0x0: "PsdNotPsd_NotPsd", 0x1: "PsdNotPsd_SPsd", 0x2: "PsdNotPsd_LPsd", 0x3: "Reserved",
             "bit_st_pos": 8, "bit_len": 2})
        info_set.append({"name": "DiagcFailrSWSM", 0x0: "DiagcFailrSWSM_NoFailr", 0x1: "DiagcFailrSWSM_CmnFailr",
                         0x2: "DiagcFailrSWSM_CoupldFailr", 0x3: "DiagcFailrSWSM_Spare", "bit_st_pos": 10,
                         "bit_len": 2})
        info_set.append({"name": "RotyPosReq5", 0x0: "PsdNotPsd_NotPsd", 0x1: "PsdNotPsd_SPsd", 0x2: "PsdNotPsd_LPsd",
                         0x3: "Reserved", "bit_st_pos": 12, "bit_len": 2})
        info_set.append({"name": "RotyDirReq5", 0x0: "PsdNotPsd_NotPsd", 0x1: "PsdNotPsd_SPsd", 0x2: "PsdNotPsd_LPsd",
                         0x3: "Reserved", "bit_st_pos": 14, "bit_len": 2})
        return info_set
    elif can_id == 0x18FF0721:
        info_set.append("SwmCem_Lin4Fr02")
        info_set.append(
            {"name": "SWM_SteerWhlHeatgPwrOn", 0x0: "Off", 0x1: "On", "bit_st_pos": 2, "bit_len": 1})
        return info_set
        ...
        info_set.append({"name": "MCU_MotorDCPower", "bit_st_pos": 32, "bit_len": 16})
        return info_set
